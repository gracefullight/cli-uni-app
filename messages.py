...
class Prompts:
    ...
    # Enrollment System
    ENROLLMENT_OPTIONS = "Student Course Menu (c/e/r/s/x): "
...
class FormatTemplates:
    ...
    # Subject Display
    SUBJECT_ITEM = "[ Subject::{subject_id} -- mark = {mark} -- grade = {grade} ]"
...
class Colors:
    ...
    # Headers (menus like University System, Admin System)
    HEADER = "cyan"

    # Sub-menus or info prompts (Student System, etc.)
    INFO = "bright_cyan"

    # Success messages (valid email, enrolled successfully)
    SUCCESS = "green"

    # Errors (invalid password, wrong email, etc.)
    ERROR = "red"

    # Highlights and warnings (Thank You, Updating Password)
    WARNING = "bold yellow"
